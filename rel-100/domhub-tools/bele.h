...
static inline unsigned be48(const unsigned char *rec) {
...
static inline unsigned le48(const unsigned char *rec) {
   return ((unsigned long long)le16(rec+2)<<32)|le32(rec);
}
